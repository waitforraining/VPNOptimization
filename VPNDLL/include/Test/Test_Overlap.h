//#ifndef __Test_Overlap_H__
//#define __Test_Overlap_H__
//
//#include <vector>
//#include <string>
//
...
//
//	//void optimizeVPNbySkeleton(const string& houseName, HouseType houseType = HT_Indoor);
//	//void optimizeVPNbySkeleton(const std::vector<WallInit::LineSegment2d>& lines, const string& outresultpath, const int& HouseType = 0);
//	//void optimizeVPNbySkeleton(const std::vector<Edge2D>& lines, const std::string& houseName, HouseType houseType = HT_Indoor);
//}
//#endif